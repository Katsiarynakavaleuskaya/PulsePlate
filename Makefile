...
ios-snapshot: ## Capture App Store screenshots via Fastlane
	...
	@cd ios && BUNDLE_PATH=vendor/bundle bundle install && BUNDLE_PATH=vendor/bundle bundle exec fastlane ios snapshot_all
...
ios-appstore-validate: ## Validate App Store screenshots, metadata, and privacy copy
	...
	@cd ios && BUNDLE_PATH=vendor/bundle bundle install && BUNDLE_PATH=vendor/bundle bundle exec fastlane ios validate_assets
...
ios-appstore-upload: ## Upload App Store metadata and screenshots (requires ASC API key env)
	...
	@cd ios && BUNDLE_PATH=vendor/bundle bundle install && BUNDLE_PATH=vendor/bundle bundle exec fastlane ios upload_metadata_and_screenshots
...
ios-appstore-upload-privacy: ## Upload App Privacy answers (requires Apple ID session env)
	...
	@cd ios && BUNDLE_PATH=vendor/bundle bundle install && BUNDLE_PATH=vendor/bundle bundle exec fastlane ios upload_app_privacy
