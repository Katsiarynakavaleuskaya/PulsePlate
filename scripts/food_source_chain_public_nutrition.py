"""CLI for the deterministic PR12 chain public nutrition governance gate."""
...
def main() -> int:
    ...
    if args.json_output:
        ...
        print("food_source_chain_public_nutrition: PASS")
    else:
        print("food_source_chain_public_nutrition: FAIL")
