"""CLI for the deterministic PR18 regional catalog provider terms matrix gate."""
...
def main() -> int:
    ...
    report = build_regional_catalog_provider_terms_report(
        ...
        provider_terms_path=args.provider_terms,
    )
    if args.json_output:
        print(json.dumps(report, indent=2, sort_keys=True))
    elif report["success"]:
        print("food_source_regional_catalog_provider_terms: PASS")
    else:
        print("food_source_regional_catalog_provider_terms: FAIL")
