...
POST_OPEN_REVIEW_GUIDANCE = (
    ...
    "`pr_review_closeout.py freeze`. Satisfy the final review-evidence slot with "
    "exactly one of a completed exact-head `pulseplate-pr-review` or an unedited "
    "trusted terminal GitHub Codex Connector rate/usage-limit receipt with "
