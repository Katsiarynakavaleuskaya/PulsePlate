"""CLI for the deterministic PR20 source-specific terms closeout gate."""
...
def main() -> int:
    ...
    if args.json_output:
        ...
        print("food_source_regional_catalog_source_specific_terms_closeout: PASS")
    else:
        print("food_source_regional_catalog_source_specific_terms_closeout: FAIL")
