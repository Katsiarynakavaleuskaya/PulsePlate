"""CLI for the deterministic PR17 regional catalog identity/license gate."""
...
from core.food_sources.regional_catalog_identity import build_regional_catalog_identity_report
...
def main() -> int:
    ...
    report = build_regional_catalog_identity_report(
        ...
        regional_identity_path=args.regional_identity,
    )
    if args.json_output:
        print(json.dumps(report, indent=2, sort_keys=True))
    elif report["success"]:
        print("food_source_regional_catalog_identity: PASS")
    else:
        print("food_source_regional_catalog_identity: FAIL")
