"""CLI for the deterministic PR21 dedicated legal-contract review gate."""
...
def main() -> int:
    ...
    if args.json_output:
        ...
        print("food_source_regional_catalog_dedicated_legal_contract_review: PASS")
    else:
        print("food_source_regional_catalog_dedicated_legal_contract_review: FAIL")
