...
SCAFFOLD_REQUIRED_ANCHORS = (
    ...
    ("no semantic similarity", re.compile(r"\bsemantic similarity\b")),
    ("no Redis", re.compile(r"\bredis\b")),
    ("no GPTCache", re.compile(r"\bgptcache\b")),
    ("no vector search", re.compile(r"\bvector search\b")),
    ("no provider changes", re.compile(r"\bprovider changes\b")),
    ("no runtime wiring", re.compile(r"\bruntime wiring\b")),
    ...
    ("partition surface", re.compile(r"\bsurface\b")),
    ("partition context fingerprint", re.compile(r"\bcontext fingerprint\b")),
    ("partition source fingerprints", re.compile(r"\bsource fingerprints\b")),
    ("partition policy version", re.compile(r"\bpolicy version\b")),
    ("partition provider key", re.compile(r"\bprovider key\b")),
    ("partition model key", re.compile(r"\bmodel key\b")),
    ("partition user tier", re.compile(r"\buser tier\b")),
    ("partition transparency notice id", re.compile(r"\btransparency notice id\b")),
