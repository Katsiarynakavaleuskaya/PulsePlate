...
PHILOSOPHY_ADMISSION_FORBIDDEN_PATTERNS = (
    (
        ...
        re.compile(
            ...
            r"|\b(?:the )?(?:(?:global )?semantic[- ]cache|global) gate "
            r"(?:(?:is|was|has been) still |(?:still )?remains |stayed |stays )open\b"
            ...
            r"|\b(?:the )?(?:(?:global )?semantic[- ]cache|global) gate "
            r"(?:will|shall) (?:be )?(?:open|opened|unlocked|activated|enabled) "
            r"(?:in|during|with|by) (?:philosophy )?pr-1\b"
    ...
    (
        ...
        re.compile(
            ...
            r"verification[- ]bundle\b"
            r"|\b(?:semantic[- ]cache |cache )?admission "
            r"bypasses (?:a )?verification[- ]bundle\b"
            r"|\b(?:semantic[- ]cache |cache )?admission "
            r"skips (?:a )?verification[- ]bundle\b"
            r"|\b(?:semantic[- ]cache |cache )?admission "
    ...
    (
        ...
        re.compile(
            ...
            r"|\b(?:philosophy admission|philosophy pr-1|pr-1) "
            r"(?:serves|served|has served|had served) "
