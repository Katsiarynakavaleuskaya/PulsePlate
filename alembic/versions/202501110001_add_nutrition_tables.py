...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("protein_g <= 200", name="ck_recipe_protein_max"),
        sa.CheckConstraint("fat_g >= 0", name="ck_recipe_fat_positive"),
        sa.CheckConstraint("fat_g <= 150", name="ck_recipe_fat_max"),
        sa.CheckConstraint("carbs_g >= 0", name="ck_recipe_carbs_positive"),
        sa.CheckConstraint("carbs_g <= 400", name="ck_recipe_carbs_max"),
        sa.CheckConstraint("fiber_g >= 0", name="ck_recipe_fiber_positive"),
        sa.CheckConstraint("fiber_g <= 50", name="ck_recipe_fiber_max"),
    ...
    op.create_table(
        ...
        sa.CheckConstraint("kcal <= 2000", name="ck_meal_kcal_max"),
        sa.CheckConstraint("protein_g >= 0", name="ck_meal_protein_positive"),
        sa.CheckConstraint("protein_g <= 200", name="ck_meal_protein_max"),
        sa.CheckConstraint("fat_g >= 0", name="ck_meal_fat_positive"),
        sa.CheckConstraint("fat_g <= 150", name="ck_meal_fat_max"),
        sa.CheckConstraint("carbs_g >= 0", name="ck_meal_carbs_positive"),
        sa.CheckConstraint("carbs_g <= 400", name="ck_meal_carbs_max"),
        sa.CheckConstraint("fiber_g >= 0", name="ck_meal_fiber_positive"),
        sa.CheckConstraint("fiber_g <= 50", name="ck_meal_fiber_max"),
    )
