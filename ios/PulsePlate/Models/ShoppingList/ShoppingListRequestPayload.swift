...
public struct ShoppingListRequestPayload: Encodable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let preferences {
            ...
            let prefsDecoded = try JSONDecoder().decode(AnyCodable.self, from: prefsData)
...
private struct AnyCodable: Codable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        if let dict = value as? [String: Any] {
            try container.encode(dict.mapValues { AnyCodable(value: $0) } as [String: AnyCodable])
        } else if let array = value as? [Any] {
            try container.encode(array.map { AnyCodable(value: $0) } as [AnyCodable])
