...
module SemanticPolicy
  ...
  METADATA_MEDICAL_CLAIMS = /
    ...
    \b(?:ИМТ|медицин(?:а|ский|ская|ские|ских)|врач(?:а|ей|ом)?|диагноз(?:а|ом|е|ы)?|пациент(?:а|ов)?|терап(?:ия|ии|ию|ией)|клиничес[а-яё]*)\b|
  ...
  STORE_TRUTH_CLAIMS = [
    ...
    /\b(?:скидк[а-яё]*|промокод[а-яё]*|купон[а-яё]*)\b/i,
