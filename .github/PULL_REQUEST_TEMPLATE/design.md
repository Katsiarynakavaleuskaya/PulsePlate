...
Explain why this work matters for launch quality, trust, retention, revenue, automation, or operational leverage.

## Scope

- State whether this PR is docs-only, tooling/docs/tests, web runtime, iOS runtime, release/assets, or research/prompt evolution.
- List only the docs, tooling, tests, or runtime surfaces explicitly owned by this PR.
