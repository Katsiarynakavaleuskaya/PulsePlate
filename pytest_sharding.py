...
SHARD_MAP = {
    ...
    4: {
        "name": "analytics",
        "patterns": ["test_bayesian_", "test_comprehensive_", "test_integrated_", "test_nutrition_bayesian_"],
    ...
    6: {
        ...
        "patterns": ["test_export_", "test_week_", "test_shoplist_", "test_daily_", "test_menu_", "test_plate_"],
