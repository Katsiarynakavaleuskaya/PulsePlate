...
from app.services.pro_nutrition_plate import _macros_to_kcal, calculate_heuristic_macros
...
class TestAppLines2482_2540:
    ...
    def test_macros_to_kcal_invalid_types(self) -> None:
        ...
        # Non-numeric values
        result = _macros_to_kcal({"protein_g": "invalid", "fat_g": 10, "carbs_g": 50})
        assert result is None

        # None values
        result = _macros_to_kcal({"protein_g": None, "fat_g": 10, "carbs_g": 50})
        assert result is None
    ...
    def test_calculate_heuristic_macros_1200_floor(self) -> None:
        ...
        prot, fat, carbs = calculate_heuristic_macros(800, 70.0)
        total = _macros_to_kcal({"protein_g": prot, "fat_g": fat, "carbs_g": carbs})
    ...
    def test_calculate_heuristic_macros_scaling_edge_case(self) -> None:
        ...
        prot, fat, carbs = calculate_heuristic_macros(1200, 200.0)
    ...
    def test_calculate_heuristic_macros_normal_case(self) -> None:
        ...
        prot, fat, carbs = calculate_heuristic_macros(2000, 70.0)
