...
class TestFoodMergeHypothesis96:
    ...
    def test_classify_food_group_property_based(
        self, name, kcal, protein_g, fat_g, carbs_g, fiber_g
    ):
    ...
    @given(
        st.lists(
            st.builds(
                lambda name, kcal, protein_g, fat_g, carbs_g, fiber_g, source, flags: FoodRecord(
                    name=name,
                    locale="en",
                    per_g=100.0,
                    kcal=kcal,
    ...
    @given(
        st.lists(
            st.builds(
                lambda name, source, flags: FoodRecord(
                    name=name,
                    locale="en",
                    per_g=100.0,
                    kcal=100.0,
