...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Semantic-cache will be enabled.", "semantic cache direct activation"),
        ("Semantic-cache has gone live.", "semantic cache active status"),
        ...
        ("GraphRAG will be approved.", "forbidden runtime surface"),
        ("GraphRAG has gone live.", "forbidden runtime surface"),
