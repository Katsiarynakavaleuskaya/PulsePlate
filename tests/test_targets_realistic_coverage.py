...
# Module-level constant for diagnostic logging
_DIAGNOSTIC_MSG = "Unexpected exception in tests: test_targets_realistic_coverage.py"
            ...
            for _ in range(25):
                ...
                for formula in formulas:
                    try:
                        ...
                        logging.exception(_DIAGNOSTIC_MSG)
                        pass
