...
class TestLlmSimple96:
    ...
    def test_get_provider_grok_keyword_args_fail(self):
        ...
        with patch('llm.GrokProvider') as mock_grok_provider, \
             patch('llm.GrokLiteProvider') as mock_grok_lite, \
             patch.dict(os.environ, {'LLM_PROVIDER': 'grok', 'GROK_ENDPOINT': 'http://test', 'GROK_API_KEY': 'test_key', 'GROK_MODEL': 'test_model'}):
    ...
    def test_get_provider_ollama_keyword_args_fail(self):
        ...
        with patch('llm.OllamaProvider') as mock_ollama_provider, \
             patch.dict(os.environ, {'LLM_PROVIDER': 'ollama', 'OLLAMA_ENDPOINT': 'http://test', 'OLLAMA_MODEL': 'test_model', 'OLLAMA_TIMEOUT': '5'}):
    ...
    def test_get_provider_ollama_timeout_float_conversion(self):
        ...
        with patch('llm.OllamaProvider') as mock_ollama_provider, \
             patch.dict(os.environ, {'OLLAMA_ENDPOINT': 'http://test', 'OLLAMA_MODEL': 'test_model', 'OLLAMA_TIMEOUT': '10.5'}):
    ...
    def test_get_provider_ollama_default_timeout(self):
        ...
        with patch('llm.OllamaProvider') as mock_ollama_provider, \
             patch.dict(os.environ, {'LLM_PROVIDER': 'ollama', 'OLLAMA_ENDPOINT': 'http://test', 'OLLAMA_MODEL': 'test_model'}, clear=True):
    ...
    def test_get_provider_ollama_default_endpoint(self):
        ...
        with patch('llm.OllamaProvider') as mock_ollama_provider, \
             patch.dict(os.environ, {'LLM_PROVIDER': 'ollama', 'OLLAMA_MODEL': 'test_model'}, clear=True):
    ...
    def test_get_provider_ollama_default_model(self):
        ...
        with patch('llm.OllamaProvider') as mock_ollama_provider, \
             patch.dict(os.environ, {'LLM_PROVIDER': 'ollama', 'OLLAMA_ENDPOINT': 'http://test'}, clear=True):
    ...
    def test_get_provider_ollama_when_unavailable(self):
        ...
        with patch('llm.OllamaProvider', None), \
