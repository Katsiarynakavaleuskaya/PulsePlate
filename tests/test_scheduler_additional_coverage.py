"""
Additional tests to improve coverage for core/food_apis/scheduler.py to reach 97%+.
"""
...
class TestSchedulerAdditionalCoverage:
    ...
    def test_signal_handler_setup_exception(self):
        """Test _setup_signal_handlers with exception."""
