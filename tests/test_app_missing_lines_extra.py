...
class TestAppMissingLinesExtra:
    ...
    def test_lifespan_error_branches(self):
        ...
        with patch.object(
            app_mod, "start_background_updates", _boom_start
    ...
    def test_insight_implicit_disabled_flag_branch(self):
        ...
        with patch.dict(os.environ, {"FEATURE_INSIGHT": "maybe"}, clear=False), patch(
            "llm.get_provider", return_value=_Stub()
        ):
    ...
    def test_premium_bmr_value_and_http_errors(self):
        ...
        with patch.object(
            app_mod, "calculate_all_bmr", side_effect=ValueError("bad")
        ), patch.object(
            app_mod, "calculate_all_tdee", lambda *a, **k: {}
        ), patch.object(
            app_mod, "get_activity_descriptions", lambda: {}
        ):
            data = {
                "weight_kg": 70.0,
                "height_cm": 175.0,
    ...
    def test_premium_plate_missing_bmr_tdee_check(self):
        ...
        with patch.object(app_mod, "calculate_all_bmr", None), patch.object(
            app_mod, "calculate_all_tdee", None
    ...
    def test_nutrient_gaps_value_error(self):
        ...
        with patch.object(
            app_mod, "analyze_nutrient_gaps", lambda *a, **k: {}
        ), patch.object(
