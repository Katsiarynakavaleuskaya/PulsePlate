...
class TestBusinessAnalysisEndpoint:
    ...
    def test_analyzer_exception_wrapped_as_500(self, test_client, monkeypatch):
    ...
    def test_http_exception_passed_through_unchanged(self, test_client, monkeypatch):
    ...
    def test_status_endpoint_reflects_module_state(self, test_client, monkeypatch):
    ...
    def test_error_type_handling_when_analyzer_returns_error(self, test_client, monkeypatch):
    ...
    def test_multiple_results_returned_as_list(self, test_client, monkeypatch):
