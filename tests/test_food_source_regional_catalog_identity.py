...
@pytest.mark.parametrize(
    ...
    (
        ...
        "Ozon and Wildberries remain seller terms evidence. They are source authority.",
        "Regional catalog candidates remain review context only. They are product display.",
        ...
        "Seller API has approvals for testing.",
        "Source authority belongs to Seller API for regional catalog updates.",
        "Source authority can be Seller API for regional catalogs.",
        "Nutrition authority can be Partner API for products.",
        "Seller API will be source authority for products.",
        "Seller API must be source authority for products.",
        "Seller API became source authority for products.",
        "Source authority was Seller API for products.",
        "Source authority: Seller API.",
        "Regional catalog candidates remain review context only. They were source authority.",
        ...
        "Approved for staging. Seller API remains blocked for PR17.",
        "Seller API is accepted for staging.",
        "Seller API is endorsed for staging.",
        "Seller API is licensed for staging.",
        "Seller API has a license for staging.",
        "Seller API has endorsement for staging.",
        "Seller API receives acceptance for staging.",
        "Seller API obtains a license for staging.",
        "Seller API secures a license for staging.",
        "Seller API obtains endorsement for staging.",
        "Seller API obtains acceptance for staging.",
        "A license is issued to Seller API for staging.",
        "Seller API is issued a license for staging.",
        "Seller API is awarded acceptance for staging.",
        "Seller API acquires a license for staging.",
        "Seller API gains endorsement for staging.",
        "Seller API earns acceptance for staging.",
        "A license for Seller API is issued for staging.",
        "Seller API license is issued for staging.",
        "Acceptance for Seller API is awarded for staging.",
        "Seller API acceptance is awarded for staging.",
        "Endorsement for Seller API is earned for staging.",
        "Seller API endorsement is earned for staging.",
        "Seller API is given a license for staging.",
        "Seller API is assigned a license for staging.",
        "Seller API is provided a license for staging.",
        "Seller API is conferred a license for staging.",
        "A license is assigned to Seller API for staging.",
        "A license is provided to Seller API for staging.",
        "Seller API receives licensing for staging.",
        "Licensing is issued to Seller API for staging.",
        "Seller API licensing is issued for staging.",
        "Licensure is issued to Seller API for staging.",
        "Seller API license is valid for staging.",
        "Seller API license is active for staging.",
        "Seller API license is in force for staging.",
        "Seller API license is currently valid for staging.",
        "Seller API license is currently active for staging.",
        "A license for Seller API is currently valid for staging.",
        "Seller API license is now valid, for staging.",
        "Seller API license remains valid for staging.",
        "Seller API license stays active for staging.",
        "Seller API license continues valid for staging.",
        "Seller API license continues active for staging.",
        "Seller API possesses a license for staging.",
        "Seller API possesses licensure for staging.",
        "Seller API maintains a license for staging.",
        "Seller API carries a license for staging.",
        "Seller API owns a license for staging.",
        "A license belongs to Seller API for staging.",
        "Seller API license exists for staging.",
        "Seller API retains a license for staging.",
        "Seller API keeps a license for staging.",
        "Seller API license applies for staging.",
        "A license applies to Seller API for staging.",
        "Seller API license is applicable for staging.",
        "Seller API is covered by a license for staging.",
        "A license covers Seller API for staging.",
        "Seller API is under a license for staging.",
        "Seller API is under licensing for staging.",
        "Seller API operates under a license for staging.",
        "Seller API falls under a license for staging.",
        "Seller API falls under licensing for staging.",
        "Seller API comes under a license for staging.",
        "Seller API is subject to a license for staging.",
        "Seller API is governed by a license for staging.",
        "Seller API is governed under a license for staging.",
        "Seller API is bound by a license for staging.",
        "Seller API is regulated by a license for staging.",
        "Seller API is controlled by a license for staging.",
        "Seller API is constrained by a license for staging.",
        "A license governs Seller API for staging.",
        "Licensing governs Seller API for staging.",
        "A license regulates Seller API for staging.",
        "A license controls Seller API for staging.",
        "A license constrains Seller API for staging.",
        "Seller API license is not valid but approved for staging.",
        "Seller API is not under a license but approved for staging.",
...
@pytest.mark.parametrize(
    ...
    (
        ...
        "Seller API license is not valid for staging.",
        "Seller API license is not active for staging.",
        "Seller API license is currently not valid for staging.",
        "Seller API license remains not valid for staging.",
        ...
        "Seller API license does not cover staging.",
        "A license does not cover Seller API for staging.",
        "No license covers Seller API for staging.",
        "Seller API is covered by no license for staging.",
        "Seller API license doesn't cover staging.",
        "A license doesn't cover Seller API for staging.",
        "Seller API is not covered by any license for staging.",
        "Seller API is never covered by any license for staging.",
        "Seller API is not covered under a license for staging.",
        "Seller API is not covered under any license for staging.",
        "Seller API isn't covered by a license for staging.",
        "Seller API isn't covered under a license for staging.",
        "Seller API is covered under no license for staging.",
        "Seller API is covered with no license for staging.",
        "Seller API is not covered with a license for staging.",
        "Seller API license doesn't remain covered for staging.",
        "Seller API license doesn't stay covered for staging.",
        "Seller API license doesn't continue covered for staging.",
        "Seller API license isn't covered for staging.",
        "Seller API license isn't currently covered for staging.",
        ...
        "A license does not regulate Seller API for staging.",
        "A license does not control Seller API for staging.",
        "A license does not constrain Seller API for staging.",
        "No license governs Seller API for staging.",
        "No licensing regulates Seller API for staging.",
        "Seller API isn't approved for testing.",
        "Seller API wasn't approved for testing.",
        "Seller API is not used for testing.",
        "Seller API is not being used for testing.",
        "Seller API is not currently used for testing.",
        "Seller API is currently not used for testing.",
        "Seller API was not used for testing.",
        "Seller API wasn't used for testing.",
        "Seller API cannot be used for testing.",
        "Source authority is not Seller API for PR17.",
