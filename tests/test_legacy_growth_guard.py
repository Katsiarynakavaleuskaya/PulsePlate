...
@pytest.mark.parametrize(
    ("lookup", "symbol"),
    [
        ('legacy.__dict__["get_api_key"]', "get_api_key"),
        ('vars(legacy)["_get_api_key_dynamic"]', "_get_api_key_dynamic"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        'lookup = getattr(object, "__getattribute__")\n',
        'lookup = object.__dict__["__getattribute__"]\n',
        'lookup = vars(object)["__getattribute__"]\n',
        'lookup = object.__getattribute__(object, "__getattribute__")\n',
        "lookup = object.__getattribute__.__call__\n",
        "lookup = object.__getattribute__.__call__.__call__\n",
        'lookup = getattr(object.__getattribute__, "__call__")\n',
    ],
    ids=[
        "direct-method",
        "getattr-method",
        "namespace-subscript-method",
        "vars-method",
...
def test_api_key_ownership_guard_rejects_aliased_object_getattribute_lookup(
    lookup_setup: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
    ...
    app_source = (
        f'import legacy_app as legacy\n{lookup_setup}dependency = lookup(legacy, "get_api_key")\n'
    )
...
@pytest.mark.parametrize(
    "helper_setup",
    [
        "lookup = legacy.__getattribute__\n",
        'lookup = getattr(legacy, "__getattribute__")\n',
        'lookup = object.__getattribute__(legacy, "__getattribute__")\n',
        "lookup = legacy.__getattribute__.__call__\n",
        "lookup = legacy.__getattribute__.__call__.__call__\n",
        'lookup = getattr(legacy.__getattribute__, "__call__")\n',
    ],
    ids=[
        "direct",
        "getattr",
...
def test_api_key_ownership_guard_rejects_aliased_legacy_getattribute_lookup(
    helper_setup: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
    ...
    app_source = f'import legacy_app as legacy\n{helper_setup}dependency = lookup("get_api_key")\n'
...
@pytest.mark.parametrize(
    ...
    [
        ...
        'obj = __builtins__["object"]\n',
        'import builtins\nobj = builtins.__dict__["object"]\n',
        'import builtins\nobj = getattr(builtins, "object")\n',
    ],
    ids=[
        "assigned-owner",
        "imported-owner",
        "implicit-builtins-owner",
        "module-builtins-owner",
        "getattr-builtins-owner",
    ],
)
def test_api_key_ownership_guard_rejects_aliased_object_owner_lookup(
    owner_setup: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
    ...
    app_source = (
        "import legacy_app as legacy\n"
        f"{owner_setup}"
        'dependency = obj.__getattribute__(legacy, "get_api_key")\n'
    )
...
def test_api_key_ownership_guard_allows_object_getattribute_on_safe_target() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
    ...
    app_source = (
        "class Safe:\n"
        "    get_api_key = object()\n"
        'dependency = object.__getattribute__(Safe(), "get_api_key")\n'
    )
...
def test_api_key_ownership_guard_allows_reassigned_object_owner() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
    ...
    app_source = (
        "import legacy_app as legacy\n"
        "obj = object\n"
        "obj = type('SafeOwner', (), {'__getattribute__': lambda self, target, name: object()})\n"
        'dependency = obj.__getattribute__(legacy, "get_api_key")\n'
    )
...
def test_api_key_ownership_guard_allows_reassigned_object_getattribute_helper() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
    ...
    app_source = (
        "import legacy_app as legacy\n"
        'lookup = getattr(object, "__getattribute__")\n'
        "lookup = lambda target, name: object()\n"
...
def test_api_key_ownership_guard_allows_reassigned_call_helper() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
def test_api_key_ownership_guard_allows_shadowed_builtin_object_owner() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
    ...
    app_source = (
        ...
        "class SafeOwner:\n"
        "    @staticmethod\n"
        "    def __getattribute__(target, name):\n"
        "        return object()\n"
        '__builtins__ = {"object": SafeOwner}\n'
        'obj = __builtins__["object"]\n'
        'dependency = obj.__getattribute__(legacy, "get_api_key")\n'
    )
...
@pytest.mark.parametrize(
    "body",
    [
        "def resolve():\n    return getattr(legacy, symbol, None)\n",
        "resolver = lambda: getattr(legacy, symbol, None)\n",
        "class Resolver:\n    dependency = getattr(legacy, symbol, None)\n",
        "dependencies = [getattr(legacy, symbol, None) for item in items]\n",
    ],
    ids=["function", "lambda", "class", "comprehension"],
)
def test_api_key_ownership_guard_propagates_static_lookup_name_into_nested_scope(
    body: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
...
def test_api_key_ownership_guard_nested_static_lookup_respects_argument_shadow() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
def test_api_key_ownership_guard_joins_conditional_alias_states(branches: str) -> None:
    ...
    app_source = f"import legacy_app as legacy\n{branches}dependency = compat.get_api_key\n"
...
def test_api_key_ownership_guard_joins_conditional_expression_aliases(
    ...
    app_source = f"import legacy_app as legacy\n{assignment}dependency = compat.get_api_key\n"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        'import sys\ncompat = sys.modules["legacy_app"]\n',
        ('from sys import modules as loaded_modules\ncompat = loaded_modules.get("legacy_app")\n'),
    ],
    ids=[
        "builtin-import",
...
def test_api_key_ownership_guard_rejects_indirect_legacy_module_loaders(
    loader_source: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
    ...
    app_source = f"{loader_source}dependency = compat.get_api_key\n"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "import builtins\n"
            "load_module = builtins.__import__\n"
            "load_module = lambda name: object()\n"
            'compat = load_module("legacy_app")\n'
            "dependency = compat.get_api_key\n"
        ),
        (
...
@pytest.mark.parametrize(
    ...
    ids=[
        ...
        "async-for-zero-iterations",
        "try-prefix-exception",
        "try-star-prefix-exception",
        "with-suppressed-prefix-exception",
        "async-with-suppressed-prefix-exception",
        "match-unmatched-guard",
    ],
)
def test_api_key_ownership_guard_preserves_legacy_alias_across_compound_paths(
    app_source: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
...
def test_api_key_ownership_guard_computes_loop_alias_fixed_point() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
def test_api_key_ownership_guard_rescans_while_test_with_backedge_aliases() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
    ...
    app_source = (
        ...
        "source = object()\n"
        "first = True\n"
        "while first or source.get_api_key:\n"
        "    if first:\n"
        "        first = False\n"
        "        source = legacy\n"
        "        continue\n"
...
def test_api_key_ownership_guard_stops_loop_flow_at_abrupt_transfer(
    transfer: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
...
def test_api_key_ownership_guard_allows_normal_loop_fallthrough_to_clear_alias() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
@pytest.mark.parametrize(
    ("transfer", "finally_body", "expected_error"),
    [
        ("break", "pass", True),
        ("continue", "pass", True),
        ("break", "compat = object()", False),
        ("continue", "compat = object()", False),
    ],
    ids=[
        "try-break-keeps-legacy",
        "try-continue-keeps-legacy",
        "finally-clears-try-break",
        "finally-clears-try-continue",
    ],
)
def test_api_key_ownership_guard_applies_finally_to_loop_transfer(
    transfer: str,
    finally_body: str,
    expected_error: bool,
) -> None:
...
@pytest.mark.parametrize(
    ...
    ids=["nested-loop-exception", "nested-if-exception"],
)
def test_api_key_ownership_guard_propagates_nested_exception_alias_state(
    nested_body: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
...
def test_api_key_ownership_guard_allows_finally_to_clear_nested_exception_alias() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
def test_api_key_ownership_guard_applies_inner_finally_before_outer_handler() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
def test_api_key_ownership_guard_keeps_outer_static_name_lexical() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
def test_api_key_ownership_guard_updates_global_static_name_in_runtime_order() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
@pytest.mark.parametrize(
    ("branch_value", "expected_error"),
    [("get_api_key", True), ("safe", False)],
    ids=["all-sensitive-branches", "all-safe-branches"],
)
def test_api_key_ownership_guard_joins_global_static_names_across_branches(
    branch_value: str,
    expected_error: bool,
) -> None:
    legacy_source = (
    ...
    expected = ["app/main.py: dynamic legacy API-key dependency lookup is forbidden: get_api_key"]
    assert errors == (expected if expected_error else [])


def test_api_key_ownership_guard_tracks_destructured_legacy_alias() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
@pytest.mark.parametrize(
    "assignment",
    [
        "compat, *rest = legacy, object()",
        "*rest, compat = object(), legacy",
    ],
    ids=["starred-suffix", "starred-prefix"],
)
def test_api_key_ownership_guard_tracks_starred_destructured_alias(
    assignment: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
...
def test_api_key_ownership_guard_allows_safe_starred_destructured_alias() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
    ...
    app_source = (
        "import legacy_app as legacy\n"
        "safe, *rest = object(), legacy\n"
        "dependency = safe.get_api_key\n"
    )
...
def test_api_key_ownership_guard_snapshots_simultaneous_starred_assignment() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
@pytest.mark.parametrize(
    ...
    [
        ("compat, *rest = a, (a := object())", True),
        ("*rest, compat = (a := object()), a", False),
    ],
    ids=["capture-before-walrus", "walrus-before-capture"],
)
def test_api_key_ownership_guard_snapshots_rhs_elements_left_to_right(
    assignment: str,
    expected_error: bool,
) -> None:
    legacy_source = (
...
@pytest.mark.parametrize(
    "lookup",
    [
        "(legacy if enabled else object()).get_api_key",
        'getattr((compat := legacy), "get_api_key")',
        "((compat := legacy) or object()).get_api_key",
    ],
    ids=["conditional-receiver", "walrus-getattr", "boolop-receiver"],
)
def test_api_key_ownership_guard_rejects_legacy_valued_expression_lookup(
    lookup: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
    ...
    expected_fragment = (
        ...
        if lookup.startswith("getattr")
        else "legacy API-key dependency attribute access"
    )
    assert len(errors) == 1
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "[legacy][0]",
        '{"guard": legacy}["guard"]',
        '{"guard": object(), "guard": legacy}["guard"]',
        '{"guard": object(), **{"guard": legacy}}["guard"]',
    ],
    ids=[
        "tuple-index",
        ...
        "list-index",
        "dict-key",
        "dict-last-duplicate-key",
        "dict-unpack-last-write",
    ],
)
def test_api_key_ownership_guard_rejects_literal_subscript_receiver(
    receiver: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
    ...
    app_source = f"import legacy_app as legacy\ndependency = {receiver}.get_api_key\n"
...
@pytest.mark.parametrize(
    ...
    [
        "(legacy, object())[1]",
        "[object(), legacy][0]",
        '{"safe": object(), "guard": legacy}["safe"]',
        '{"guard": legacy, "guard": object()}["guard"]',
        '{"guard": legacy, **{"guard": object()}}["guard"]',
    ],
    ids=[
        "safe-tuple-index",
        "safe-list-index",
        "safe-dict-key",
        "safe-dict-last-duplicate-key",
        "safe-dict-unpack-last-write",
    ],
)
def test_api_key_ownership_guard_allows_safe_literal_subscript_receiver(
    receiver: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
...
@pytest.mark.parametrize(
    ...
    ["namespace = legacy.__dict__", "namespace = vars(legacy)"],
    ids=["dunder-dict-alias", "vars-alias"],
)
def test_api_key_ownership_guard_rejects_aliased_legacy_namespace(
    namespace_assignment: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
    ...
    app_source = (
        "import legacy_app as legacy\n"
        f"{namespace_assignment}\n"
        'dependency = namespace["get_api_key"]\n'
    )
...
def test_api_key_ownership_guard_propagates_legacy_parameter_default(
    definition: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
    ...
    app_source = (
        "import legacy_app as legacy\n"
        f"{definition} resolve(compat=legacy):\n"
        "    return compat.get_api_key\n"
    )
...
@pytest.mark.parametrize("definition", ["def", "async def"])
def test_api_key_ownership_guard_keeps_safe_parameter_default_at_definition(
    definition: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
...
def test_api_key_ownership_guard_propagates_legacy_lambda_default() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
    ...
    app_source = "import legacy_app as legacy\nresolve = lambda compat=legacy: compat.get_api_key\n"
...
@pytest.mark.parametrize(
    ("default_value", "expected_error"),
    [("legacy", True), ("object()", False)],
    ids=["captured-legacy-default", "captured-safe-default"],
)
def test_api_key_ownership_guard_snapshots_lambda_default_at_definition(
    default_value: str,
    expected_error: bool,
) -> None:
    legacy_source = (
    ...
    app_source = (
        "import legacy_app as legacy\n"
        f"resolve = lambda compat={default_value}: compat.get_api_key\n"
        "legacy = object()\n"
    )
...
@pytest.mark.parametrize(
    ...
    ids=["from-builtins", "assigned-builtins"],
)
def test_api_key_ownership_guard_rejects_aliased_dynamic_lookup_helper(
    helper_import: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "lookup = vars(legacy).__getitem__",
    ],
    ids=["aliased-namespace-get", "aliased-vars-getitem"],
)
def test_api_key_ownership_guard_rejects_aliased_namespace_helper(
    helper_assignment: str,
) -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
...
def test_api_key_ownership_guard_allows_reassigned_namespace_helper() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
...
@pytest.mark.parametrize(
    ...
    [
        'getattr(legacy, "__dict__")',
        'legacy.__getattribute__("__dict__")',
        'aliased_getattr(legacy, "__dict__")',
    ],
    ids=["getattr", "dunder-getattribute", "aliased-getattr"],
)
def test_api_key_ownership_guard_rejects_dynamic_legacy_namespace(
    ...
    helper_alias = (
        "from builtins import getattr as aliased_getattr\n"
        if namespace_expression.startswith("aliased_getattr")
        else ""
    )
    app_source = (
        "import legacy_app as legacy\n"
...
def test_api_key_ownership_guard_allows_dynamic_safe_namespace() -> None:
    legacy_source = (
        "from app.routers.api_key import (\n"
        "    _get_api_key_dynamic as _get_api_key_dynamic,\n"
        "    get_api_key as get_api_key,\n"
    ...
    app_source = (
        "safe = object()\n"
        'namespace = getattr(safe, "__dict__", {})\n'
        'dependency = namespace.get("get_api_key")\n'
    )
