...
### Решение 1: Временно снизить порог покрытия (быстрое решение)

Если нужно быстро исправить CI, можно временно снизить порог до 95%:
...
### Решение 2: Добавить исключения для проблемных файлов (рекомендуется)
...
### Решение 3: Улучшить покрытие тестами (долгосрочное решение)
