...
MANUAL_MONTHLY_ENTITLEMENT_DURATION: Final[timedelta] = timedelta(days=30)
LEGACY_MANUAL_COMPAT_CUTOFF: Final[datetime] = datetime(2026, 3, 22, tzinfo=timezone.utc)
