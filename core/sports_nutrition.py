...
class SportsNutritionCalculator:
    ...
    def calculate_sports_targets(
        ...
        return SportsNutritionTargets(
            ...
            creatine_recommended=sport
            in [SportCategory.STRENGTH, SportCategory.POWER, SportCategory.COMBAT],
    ...
    def _get_weight_cutting_advice(sport: SportCategory) -> str:
        ...
        return (
            "Gradual weight loss recommended (0.5-1% body weight/week). "
            "Maintain protein intake. Consult sports nutritionist for competition prep."
        )


def get_sport_recommendations(
    profile: UserProfile,
    sport: SportCategory,
    training_phase: TrainingPhase = TrainingPhase.IN_SEASON,
    training_hours_per_week: float = 5.0,
