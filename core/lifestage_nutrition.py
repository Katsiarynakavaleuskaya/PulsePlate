...
class LifeStageNutritionCalculator:
    ...
    @classmethod
    def calculate_lifestage_targets(cls,
                                  profile: UserProfile,
                                  life_stage: LifeStage) -> Dict[str, any]:
        """
...
def get_lifestage_recommendations(profile: UserProfile,
                                is_pregnant: bool = False,
                                is_lactating: bool = False,
                                trimester: Optional[int] = None) -> Dict[str, any]:
    """
