...
class Recipe(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("kcal_per_serving <= 5000", name="ck_recipe_kcal_max"),
        CheckConstraint("protein_g >= 0", name="ck_recipe_protein_positive"),
        CheckConstraint("protein_g <= 500", name="ck_recipe_protein_max"),
        CheckConstraint("fat_g >= 0", name="ck_recipe_fat_positive"),
        CheckConstraint("fat_g <= 400", name="ck_recipe_fat_max"),
        CheckConstraint("carbs_g >= 0", name="ck_recipe_carbs_positive"),
        CheckConstraint("carbs_g <= 800", name="ck_recipe_carbs_max"),
        CheckConstraint("fiber_g >= 0", name="ck_recipe_fiber_positive"),
        CheckConstraint("fiber_g <= 150", name="ck_recipe_fiber_max"),
...
class Meal(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("kcal <= 5000", name="ck_meal_kcal_max"),
        CheckConstraint("protein_g >= 0", name="ck_meal_protein_positive"),
        CheckConstraint("protein_g <= 500", name="ck_meal_protein_max"),
        CheckConstraint("fat_g >= 0", name="ck_meal_fat_positive"),
        CheckConstraint("fat_g <= 400", name="ck_meal_fat_max"),
        CheckConstraint("carbs_g >= 0", name="ck_meal_carbs_positive"),
        CheckConstraint("carbs_g <= 800", name="ck_meal_carbs_max"),
        CheckConstraint("fiber_g >= 0", name="ck_meal_fiber_positive"),
        CheckConstraint("fiber_g <= 150", name="ck_meal_fiber_max"),
