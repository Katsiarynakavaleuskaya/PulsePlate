...
class Recipe(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("protein_g <= 150", name="ck_recipe_protein_max"),
        CheckConstraint("fat_g >= 0", name="ck_recipe_fat_positive"),
        CheckConstraint("fat_g <= 100", name="ck_recipe_fat_max"),
        CheckConstraint("carbs_g >= 0", name="ck_recipe_carbs_positive"),
        CheckConstraint("carbs_g <= 200", name="ck_recipe_carbs_max"),
        CheckConstraint("fiber_g >= 0", name="ck_recipe_fiber_positive"),
        CheckConstraint("fiber_g <= 40", name="ck_recipe_fiber_max"),
