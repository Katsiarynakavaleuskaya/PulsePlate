...
This directory contains comprehensive validation tests for the application's translation files (locale JSON files). The tests ensure that all translations maintain structural integrity, completeness, and consistency across all supported languages.
