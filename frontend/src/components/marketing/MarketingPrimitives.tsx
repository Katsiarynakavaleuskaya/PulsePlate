...
export function MarketingSection({
    ...
    return (
        <section className={["ppm-section", className].join(" ").trim()} {...props}>
...
export function MarketingCard({
    ...
    return (
        <div className={["ppm-card", className].join(" ").trim()} {...props}>
            {children}
        </div>
    );
}
...
export function StatusPill({
    ...
    className = "",
    ...props
}: PropsWithChildren<HTMLAttributes<HTMLSpanElement>>): JSX.Element {
    return (
        <span className={["ppm-pill", className].join(" ").trim()} {...props}>
            {children}
        </span>
    );
}
