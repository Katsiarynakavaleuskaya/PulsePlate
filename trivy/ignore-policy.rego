...
# Review-by: 2026-05-27 (manual removal)
# Rationale: Debian tracker reports bookworm vulnerable with no DSA/fixed package yet;
#   the alert surface is limited to runtime image OS packages, not application code.
# Monitor: https://security-tracker.debian.org/tracker/CVE-2025-69720
# Documented in: docs/security/CVE-2025-69720-ncurses.md
# Removal condition: Remove when Debian bookworm publishes fixed ncurses packages or Trivy metadata includes Fixed Version
