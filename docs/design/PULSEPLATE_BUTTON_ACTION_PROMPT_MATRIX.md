...
| Platform | Screen | Button/CTA ID | UI Label | Trigger Type | Calls/Invokes | Next Link/Flow | Backend/API Dependency | Feature/Auth Gate | Exists Now | Missing | Implement Needed | QA Coverage | Figma Node ID | Sora Prompt Stub |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
