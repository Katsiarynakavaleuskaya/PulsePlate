...
| `web.home.open_pro` | `V3` | `W_HOME_QA_GRID` | `SORA_BTN_web_home_open_pro_<variant>_<state>_V1` | `docs/design/PULSEPLATE_BUTTON_VISUAL_SYSTEM_TRENDS_AND_FORECAST.md` |
