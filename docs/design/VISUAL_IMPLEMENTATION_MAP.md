...
| Apple Product Information Boundary | P0 | `frontend/src/components/PremiumGate.tsx`, `frontend/src/components/AppleProductInfoDialog.tsx` | `frontend/src/components/PremiumGate.tsx:24`, `frontend/src/components/AppleProductInfoDialog.tsx:15` | `docs/sora/prompts/hpp/p0_visibility/premium_gate_value_frame__plate_pro__v1.0.md` | Keep the legacy prompt filename as compatibility metadata; update when the information-boundary component ownership changes. |
