# PR 1658 Fixed Mapping

## Summary

RAG invariance and mutation fixture family PR for the Evaluation Science Epic.

Adds deterministic RAG variant fixture set with 4 canonical groups (16 rows)
