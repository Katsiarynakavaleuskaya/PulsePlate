...
Evidence: Commit `33c2d04a478999f734cc43c0892354ada48d9766` keeps merge-readiness checklist boxes unchecked until the final merge cycle, adds CI/current-head/strict-wrapper/main-stability DoD requirements, and expands the unsupported-claim test regex for `doctor-recommended`.
