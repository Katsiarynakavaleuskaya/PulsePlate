...
Artifact: `artifacts/orchestration/experiments/results/pilot-b3-exact-context-compaction-headeccae01.json`
...
Disposition: FIXED
Commit: c67ea3fa6e5222c323d52abce9b24e30a251f386
Evidence: scripts/evals/run_rag_release_gates.py and the tracked notebook author exact-boolean context_compaction_runtime_fallback on enabled PulsePlate exception fallback; Gate D1 rejects it independently of peers or allow_runtime_fallbacks. tests/test_rag_release_gates_runner.py proves fallback compensation rejection; descendant 015f0dce7 preserves successful empty results without local substitution.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#discussion_r3747974369 -> c67ea3fa6e5222c323d52abce9b24e30a251f386

Disposition: FIXED
Commit: c67ea3fa6e5222c323d52abce9b24e30a251f386
Evidence: scripts/evals/run_rag_release_gates.py extends the complete exact-typed carrier with context_compaction_runtime_fallback and makes any enabled runtime fallback independently fail Gate D1. Tests prove observed peers, allow_runtime_fallbacks, and small-fixture advisory cannot compensate.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#discussion_r3748081112 -> c67ea3fa6e5222c323d52abce9b24e30a251f386

Disposition: FIXED
Commit: eccae01aadae72505538f5892353e2bbce70a5dd
Evidence: scripts/evals/run_rag_release_gates.py requires exact built-in rag_actually_used for active current carriers, rejects enabled usable-but-unattempted and observed-without-usage states, and excludes malformed evidence before aggregate counts. The notebook mirrors the same finite state; tests cover peer compensation, legitimate empty N/A, malformed applicability, and rollback controls.
...
Disposition: FIXED
Commit: 596efb25f60e98bfe3297df16677b3d30abc0b9c
Evidence: scripts/evals/run_rag_release_gates.py:1855-1951 and the tracked notebook distinguish ordinary empty/filter N/A from degraded pre-seam evidence, require observed results to have no degraded reason, and tests/test_rag_release_gates_runner.py locks both finite-state tables and adapter parity.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#discussion_r3749122892 -> 596efb25f60e98bfe3297df16677b3d30abc0b9c
...
Disposition: NOT-A-BUG
Evidence: The canonical mapping binds discussion_r3748593822 to the proven post-comment closeout commit 259806975b40c8762baa9f7542fad2e20ae0128e, and aggregate review evidence names the same proof.
Reason: The feedback correctly identified stale proof and its requested repository state is fixed in material docs commit 352270f963139b9c9b0e9ef073d928589e8936b6. The meta-thread adds no separate material defect.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#discussion_r3749122882
...
Disposition: NOT-A-BUG
Evidence: The comment states only that Codex security-review usage was rate-limited and contains no security finding. Provider-neutral no-claim records scan_claim=none and no_findings_claim=false; deterministic local security gates and internal exact-head security review remain separate evidence.
Reason: Provider unavailability is neither PASS nor a finding and, under repository no-claim policy, requires no retry and grants no bypass or merge authority.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#issuecomment-5238061133

Disposition: NOT-A-BUG
Evidence: The comment states only that Codex security-review usage was rate-limited and contains no security finding. Provider-neutral no-claim records scan_claim=none and no_findings_claim=false; deterministic local security gates and internal exact-head security review remain separate evidence.
Reason: Provider unavailability is neither PASS nor a finding and, under repository no-claim policy, requires no retry and grants no bypass or merge authority.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#issuecomment-5238751994

Disposition: NOT-A-BUG
Evidence: The comment states only that Codex security-review usage was rate-limited and contains no security finding. Provider-neutral no-claim records scan_claim=none and no_findings_claim=false; deterministic local security gates and internal exact-head security review remain separate evidence.
Reason: Provider unavailability is neither PASS nor a finding and, under repository no-claim policy, requires no retry and grants no bypass or merge authority.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#issuecomment-5238851043

Disposition: NOT-A-BUG
Evidence: The comment states only that Codex security-review usage was rate-limited and contains no security finding. Provider-neutral no-claim records scan_claim=none and no_findings_claim=false; deterministic local security gates and internal exact-head security review remain separate evidence.
Reason: Provider unavailability is neither PASS nor a finding and, under repository no-claim policy, requires no retry and grants no bypass or merge authority.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#issuecomment-5239143294
...
Disposition: NOT-A-BUG
Evidence: The review aggregation has one actionable inline child discussion_r3747974369, separately mapped FIXED to c67ea3fa6e5222c323d52abce9b24e30a251f386.
Reason: The top-level review body contains no independent finding beyond its disposition-mapped child thread.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#pullrequestreview-4895077987

Disposition: NOT-A-BUG
Evidence: The review aggregation has one actionable inline child discussion_r3748081112, separately mapped FIXED to c67ea3fa6e5222c323d52abce9b24e30a251f386.
Reason: The top-level review body contains no independent finding beyond its disposition-mapped child thread.
- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/2249#pullrequestreview-4895191564

Disposition: NOT-A-BUG
Evidence: The review aggregation has one actionable inline child discussion_r3748531565, separately mapped FIXED to eccae01aadae72505538f5892353e2bbce70a5dd.
Reason: The top-level review body contains no independent finding beyond its disposition-mapped child thread.
...
{"authority":"human_asserted_content_receipt","code_review":{"blocking":false,"material_digest":"sha256:c2ed028f6e9d191731c318ade1211a8c658ae486a76576e4f4ea9696a71924a0","material_head_sha":"352270f963139b9c9b0e9ef073d928589e8936b6","output_required":false,"review_claim":"none"},"codex_security":{"base_revision":"48b04c2267aa7ff8708feb348c64bdf68ac52ba7","blocking":false,"head_revision":"352270f963139b9c9b0e9ef073d928589e8936b6","material_digest":"sha256:c2ed028f6e9d191731c318ade1211a8c658ae486a76576e4f4ea9696a71924a0","no_findings_claim":false,"output_required":false,"scan_claim":"none"},"material":{"base_ref_oid":"48b04c2267aa7ff8708feb348c64bdf68ac52ba7","digest":"sha256:c2ed028f6e9d191731c318ade1211a8c658ae486a76576e4f4ea9696a71924a0","material_head_sha":"352270f963139b9c9b0e9ef073d928589e8936b6","merge_base_sha":"48b04c2267aa7ff8708feb348c64bdf68ac52ba7","policy_version":"pulseplate.material-classification/v1"},"pr_number":2249,"repository":"Katsiarynakavaleuskaya/PulsePlate","schema_version":"pulseplate.pr-review-seal/v1","self_review":{"actionable_findings_count":0,"authority":"repo_native_pulseplate_pr_review_advisory","blocking":false,"findings_count":1,"material_digest":"sha256:c2ed028f6e9d191731c318ade1211a8c658ae486a76576e4f4ea9696a71924a0","material_head_sha":"352270f963139b9c9b0e9ef073d928589e8936b6","report_payload":{"actionable_findings_count":0,"base_ref_oid":"48b04c2267aa7ff8708feb348c64bdf68ac52ba7","calibration":{"case_labels":["large-diff-risk"],"false_positive_controls":["clean context must produce zero findings","benign fixed-mapping presence must not become a governance finding","warnings and governance uncertainty remain actionable findings, not diagnostic notes","review-source degradation is status/warning only unless an explicit blocking source finding exists","large diff risk is review-planning evidence, not a merge-readiness claim"],"posting_eligible":false,"posting_gate":"GitHub posting remains out of scope until a dedicated calibrated posting PR.","rubric_version":"pr4-2026-04-28"},"coordinator_packet":{"path":"","role_order":["agent-coordinator","architecture-specialist","security-auditor","qa-engineer-agent","bug-hunter","data-scientist-agent"],"task_packet_id":""},"decision_log":["This report is advisory and side-effect free.","This report does not post GitHub comments, resolve review threads, merge PRs, or claim merge readiness.","External CodeRabbit, Sourcery, and Cubic statuses remain separate PR governance signals."],"deferred_followups":[],"findings":[{"category":"tests","diagnostic_code":"large_diff_review_risk","disposition_candidate":"NOT-A-BUG","evidence":"Diff contains 2467 changed lines, above review-risk threshold 800.","file":"docs/roadmap/BACKLOG_LEDGER.md","gate_to_run":"make validate-changed","line":null,"role_agent":"bug-hunter","severity":"note","suggested_fix":"Confirm PR split rationale and targeted deterministic gates before opening review."}],"findings_count":1,"gate_plan":["python3 scripts/orchestration/check_preflight.py","python3 scripts/orchestration/check_agent_consistency.py","python3 -m pytest tests/test_pr_review_report.py tests/test_pr_review_context.py -q","make test-fast","make validate-changed"],"generated_at_utc":"2026-08-10T15:31:31Z","material_digest":"sha256:c2ed028f6e9d191731c318ade1211a8c658ae486a76576e4f4ea9696a71924a0","material_head_sha":"352270f963139b9c9b0e9ef073d928589e8936b6","merge_base_sha":"48b04c2267aa7ff8708feb348c64bdf68ac52ba7","mode":"dry-run-report","review_source_status":[{"blocking":false,"evidence":"gh api repos/<repo>/pulls/<pr>","fallback_required":false,"reason":"","source":"github_pr_metadata","source_degraded":false,"status":"available"},{"blocking":false,"evidence":"48b04c2267aa7ff8708feb348c64bdf68ac52ba7..352270f963139b9c9b0e9ef073d928589e8936b6","fallback_required":false,"reason":"","source":"git_diff","source_degraded":false,"status":"available"},{"blocking":false,"evidence":"docs/review/PR_2249_FIXED_MAPPING.md","fallback_required":false,"reason":"","source":"fixed_mapping_artifact","source_degraded":false,"status":"available"}],"role_review":[{"role_agent":"agent-coordinator","summary":"agent-coordinator has no deterministic findings from the supplied context."},{"role_agent":"architecture-specialist","summary":"architecture-specialist has no deterministic findings from the supplied context."},{"role_agent":"security-auditor","summary":"security-auditor has no deterministic findings from the supplied context."},{"role_agent":"qa-engineer-agent","summary":"qa-engineer-agent has no deterministic findings from the supplied context."},{"role_agent":"bug-hunter","summary":"bug-hunter flagged 1 advisory finding(s) for human review."},{"role_agent":"data-scientist-agent","summary":"data-scientist-agent has no scoring calibration changes in this dry-run report."}],"schema_version":"2.0.0","scope_reviewed":{"changed_files":[".env.example","app/services/insight_runtime.py","app/utils/feature_flags.py","core/rag/context_compaction.py","core/rag/orchestration.py","docs/contracts/RAG_CONTRACT.md","docs/roadmap/BACKLOG_LEDGER.md","notebooks/pulseplate_rag_release_gates.ipynb","scripts/evals/run_rag_release_gates.py","tests/test_app_insight_runtime.py","tests/test_philosophy_validation_integration.py","tests/test_rag_context_compaction.py","tests/test_rag_orchestration.py","tests/test_rag_release_gates_runner.py"],"diff_summary":{"additions":2417,"changed_lines":2467,"deletions":50,"files":14},"fixed_mapping_errors":[],"omitted_surfaces":["GitHub posting","PR thread resolution","merge readiness claims"],"pr_metadata_available":true,"scoped_agents_md":["AGENTS.md","app/AGENTS.md","core/AGENTS.md","scripts/AGENTS.md","tests/AGENTS.md"]},"warnings":[]},"report_sha256":"sha256:7a9a882cd9f03e5fbbbf5e64954243c94d3536b49b3a76852785e17cae7e67ee","review_claim":"none","review_tool":"pulseplate-pr-review","schema_version":"pulseplate.self-review-advisory/v1","status":"advisory_report_attached"}}
