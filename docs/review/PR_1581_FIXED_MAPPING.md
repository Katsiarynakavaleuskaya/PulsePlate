...
Disposition: FIXED
Commit: 63006f30b
Evidence: `docs/design/ACCESSIBILITY_MOTION_STATE_CONTRACT.md` uses `reduced-motion-aware`.

- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/1581#discussion_r3163753152 -> 63006f30b
Disposition: FIXED
Commit: 63006f30b
Evidence: `frontend/src/components/ui/Skeleton.tsx` preserves governed ARIA status props.

- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/1581#pullrequestreview-4200233929 -> 63006f30b
Disposition: FIXED
Commit: 63006f30b
Evidence: `docs/review/PR_1581_FIXED_MAPPING.md` includes `## Merge Readiness`.
...
Disposition: FIXED
Commit: 03ea929c1
Evidence: `frontend/src/components/ui/EmptyState.tsx` avoids duplicate live-region attributes for `role="alert"`.

- https://github.com/Katsiarynakavaleuskaya/PulsePlate/pull/1581#pullrequestreview-4200740579 -> 03ea929c1
Disposition: FIXED
Commit: 03ea929c1
Evidence: `frontend/src/components/ui/__tests__/ProgressIndicator.test.tsx` uses `previousElementSibling`.
