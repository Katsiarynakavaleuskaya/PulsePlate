...
No actionable review items are mapped yet.
Add every FIXED / NOT-A-BUG / DEFERRED disposition here before resolving the
corresponding GitHub thread or bot comment.
