...
| `.github/workflows/trivy.yml` (`trivy`) | Backend / shared PR lane | External / soft operational signal | SARIF/reporting lane; does not block ordinary PR merge by default unless branch protection promotes it | Transitional duplicate targeted by PR2 |
