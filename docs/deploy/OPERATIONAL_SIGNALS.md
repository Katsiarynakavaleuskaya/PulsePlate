...
| `/debug_env` | Local/operator debug surface | Returns a gated env dump when debug/operator access is enabled; otherwise stays unavailable to avoid production leakage | `app/routers/admin_operations.py`, `app/services/admin_operations.py` |
