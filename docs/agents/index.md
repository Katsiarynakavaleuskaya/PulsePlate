...
| marketing-strategist | auto | ASO/SEO, growth channels, positioning, conversion optimization | `.cursor/agents/marketing-strategist.md` | Marketing, growth, ASO/SEO |
...
| business-strategist-agent | auto | Director-level business ownership for portfolio framing, B2B packaging, monetization sequencing, and KPI governance | `.cursor/agents/business-strategist-agent.md` | Business prioritization, executive framing, pricing tradeoffs, partner/investor narrative alignment |
...
| prompt-engineering-eval-agent | auto | Non-routable advisory specialist for prompt contracts, offline eval harnesses, SC-G3 false-hit observability, and LLM red-team matrices | `.cursor/agents/prompt-engineering-eval-agent.md` | SC-G3 harness planning, prompt evals, semantic-cache quality metrics |
...
| project-planning-agent | auto | Non-routable advisory specialist for gate-sequenced roadmaps, milestone dependencies, risk registers, and OKR-to-backlog plans | `.cursor/agents/project-planning-agent.md` | PR trains, release sequencing, SC gates, roadmap governance |
