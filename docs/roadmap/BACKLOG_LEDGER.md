...
- [ ] P0: App Store release readiness closure for full-feature launch
  ...
  - Target PR: PR #1582 -> PR-0 merged; PR #1591 -> PR-1 merged; PR #1600 / `release/appstore-readiness-pr2-permission-purpose-strings` -> PR-2 active; PR #1618 -> PR-3 merged; PR #1619 -> PR-4 merged; PR #1620 -> PR-5 merged; PR #1621 -> PR-6 merged; PR #1622 -> PR-7 merged (release base URL fail-fast); `release/appstore-readiness-pr8-appicon-marketing-asset` -> PR-8 active (AppIcon marketing asset); remaining train `release/appstore-readiness-*`
  - Status: 🛠️ PR-0 merged in PR #1582; PR-1 merged in PR #1591; PR-2 active in draft PR #1600; PR-3 merged in PR #1618 (reviewer submission matrix); PR-4 merged in PR #1619 (screenshot asset gate); PR-5 merged in PR #1620 (fastlane metadata audit); PR-6 merged in PR #1621 (release notes template and claim policy); PR-7 merged in PR #1622 (release base URL fail-fast); PR-8 active on branch `release/appstore-readiness-pr8-appicon-marketing-asset` (AppIcon marketing asset guard)
