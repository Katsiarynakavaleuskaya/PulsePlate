...
- [ ] P1: TestClient lifecycle and session-fixture isolation cleanup
  ...
  - Status: 🟡 In progress — TC2-09F / PR #2357 is merged; TC2-09G / PR #2361 is the current bounded one-site Bayesian adherence isolated-client carrier from exact base `6c14bae635cc18f663e2faa0f7636c0a2134840e`; the tracker remains open and TC2-10 remains blocked
