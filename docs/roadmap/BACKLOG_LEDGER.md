...
- [ ] P2: Complete legacy_app.py migration (delete legacy endpoints)
  - Owner: @katsiaryna_kavaleuskaya
  - Target PR: PR #2102 -> PR #2114 -> PR #2121 -> PR #2140 -> PR #2145 -> PR #2163 (`codex/canonicalize-pro-targets-gaps-ownership`) -> PR #2170 (`codex/canonicalize-pro-plate-ownership-replacement`) -> `codex/canonicalize-premium-bmr-ownership` -> PR-TBD-BMI-PRO-RETIREMENT -> PR-TBD-LEGACY-EXPORT-RETIREMENT -> PR-TBD-INSIGHT-CUTOVER -> PR-TBD-APP-FACTORY -> PR-TBD-LEGACY-DELETION
