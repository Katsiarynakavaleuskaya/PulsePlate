...
- [ ] P1: TestClient lifecycle and session-fixture isolation cleanup
  - Owner: @katsiaryna_kavaleuskaya
  - Priority: P1
  - Target PR: PR #2312 (TC2-09), merged PR #2325 / PR #2330 stabilization, and PR #2332 direct-getter ownership stabilization; terminal TC2-10 remains TBD
  - Status: 🟡 In progress — TC2-09 and PR #2325 / PR #2330 merged; PR #2332 active; tracker remains open
  ...
  - Progress:
    ...
    - Direct-getter ownership stabilization: PR #2332 closes the complete finite three-node test cohort that directly acquired and published the unified-food singleton without restoring and closing the exact test-owned instance. Each node now requires a cold prior, performs exact identity assertions inside `try`, compare-and-swaps only its owned instance back to the prior state, closes only that owned client bundle in `finally`, and proves any foreign replacement remains preserved and unclosed. Runtime lifecycle/CAS/getter semantics and shared fixtures remain unchanged. The checkbox and tracker remain open, `TC2-09B REQUIRED`, and TC2-10 remains blocked.
