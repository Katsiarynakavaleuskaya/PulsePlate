...
- [ ] P1: Retire active emergency wheel manifest entries after approved mirror sync
  ...
  - Evidence:
    - Emergency manifest entries for the still-active fallback set remain pinned in
      ...
      `pip 26.0.1`, `cryptography 46.0.7`, `pillow 12.2.0`, `pytest 9.0.3`,
      `faker 40.15.0`, `hypothesis 6.152.4`, `sentence-transformers 5.4.1`,
      `ruff 0.15.12`, `types-pyyaml 6.0.12.20260408`, and `transformers 5.8.0`.
