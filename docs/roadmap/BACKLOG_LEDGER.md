...
- [ ] P1: Reference-driven design intelligence wave for web and iOS
  ...
  - Target PR: PR #1671 (`docs(design): open reference-driven design intelligence wave for web and iOS`, branch `docs/design-intelligence-wave-v1`) -> PR #1677 / PR-1 `feat(design): generate PulsePlate DESIGN.md from token and component contracts` -> PR #1680 / PR-2 `feat(design): add external reference manifest and normalization tooling` -> PR #1683 / PR-3 `feat(design): add screen evidence pack for web and iOS review surfaces` -> PR #1686 / PR-4 `feat(design): add deterministic design scorecard checks` -> PR #1689 / PR-5 acceptance brief `docs/design-web-launch-brief-pr5` -> PR #1694 / PR-6 `feat(ios): add iOS design parity audit and bounded visual sync` -> PR #1695 hotfix interruption -> PR #1698 / PR-7 `feat(orchestration): add design-agent workflow and PR template` -> PR #1704 / PR-8 `docs(research): add GEPA-compatible prompt/rubric evolution lane` -> PR #1707 next-lane decision `docs/design-automation-next-lane-decision-v1` -> active canon prompt lane `codex/canonical-pr-execution-prompt-v2026-05-08`
  - Status: PR-0 merged in PR #1671; PR-1 merged in PR #1677 with generated/drift-checked `docs/design/DESIGN.md`; PR-2 merged in PR #1680 with reference manifest validation and normalization tooling; PR-3 merged in PR #1683 with metadata-only screen evidence pack validation for web and iOS review surfaces; PR-4 merged in PR #1686 with deterministic evidence-quality scorecard checks; PR-5 acceptance brief merged in PR #1689 with the web shell accepted with deferred minor follow-up; PR-6 merged in PR #1694 with iOS visual parity audit and bounded sync decision; PR #1695 landed the BMI guard false-positive hotfix interruption; PR-7 merged in PR #1698 with workflow/template/test governance; PR-8 merged in PR #1704 with GEPA-compatible prompt/rubric evolution kept research/eval/process-only; PR #1707 merged the docs-only next-lane decision. The active follow-up codifies `PulsePlate Canonical PR Execution Prompt v2026-05-08` so future design/orchestration PR prompts preserve operator-owned main sync, normal PR opening, mandatory premortem-on-diff execution, coordinator-expanded role enforcement, and the bounded `make validate-changed` prompt contract.
  ...
  - Canonical PR execution prompt tracking:
    - Owner: @katsiaryna_kavaleuskaya
    - Priority: P1
    - Target PR: `docs(orchestration): codify canonical PR execution prompt v2026-05-08`, branch `codex/canonical-pr-execution-prompt-v2026-05-08`
    - Canonical name: `PulsePlate Canonical PR Execution Prompt v2026-05-08`
    - Reason: Future PulsePlate PR prompts need one guarded contract for normal PR opening, clean worktree creation from `origin/main`, worktree-local Python setup, mandatory coordinator role order, premortem execution on the actual diff, post-open and post-bot review passes, fixed mapping after fix/decision, and operator-owned post-merge local main synchronization.
    - Links: `docs/orchestration/PULSEPLATE_CANONICAL_PR_EXECUTION_PROMPT_2026_05_08.md`, `docs/orchestration/DESIGN_AGENT_WORKFLOW.md`, `docs/orchestration/DESIGN_AGENT_PR_TEMPLATE.md`, `docs/orchestration/DESIGN_AUTOMATION_NEXT_LANE_PACKET_2026-05-08.md`
    - DoD: Canonical prompt doc exists, design workflow/template/next-lane packet no longer print stale prompt commands, deterministic docs guards reject old prompt patterns, and the lane remains docs/tests/governance only.
...
- [ ] P1: Recursive methods for LLM/RAG/AI assistant (multi-hop retrieval, recursive reasoning, self-refinement, self-verification, learning)
  ...
  - Status: 🟡 In progress via PR #1499 (bounded W1 recursive lane active on `codex/ai-recursive-methods-w1`)
  - Dependencies:
