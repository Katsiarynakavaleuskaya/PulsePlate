...
- [ ] P1: Governed agent experimentation lane (PR1-PR6 orchestration epic)
  ...
  - Target PR: PR #1073 -> PR #1081 -> PR #1088 -> PR #1092 -> PR_TBD_AGENT_EXPERIMENT_CV_LANE
  - Status: 🟡 In progress (PR1 governance merged in `#1073`; PR2 bootstrap tooling merged in `#1081`; PR3 runner MVP merged in `#1088`; PR4 promotion/telemetry merged in `#1092` on 2026-03-11; PR5 CV experimentation lane is next)
