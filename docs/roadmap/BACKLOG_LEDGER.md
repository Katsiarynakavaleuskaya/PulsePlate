...
- [ ] P1: TestClient lifecycle and session-fixture isolation cleanup
  ...
  - Status: 🟡 In progress — TC2-09G / PR #2361 is merged; TC2-09H / PR #2366 is the current bounded two-site executable-string import-order lifecycle carrier from synchronized exact base `74a49df1509b65d6d8ce764b7300ebca81173ee6`; the tracker remains open and TC2-10 remains blocked
