...
- [ ] P1: TestClient lifecycle and session-fixture isolation cleanup
  ...
  - Status: 🟡 In progress — TC2-09F / PR #2357 is merged; TC2-09G is the current bounded one-site Bayesian adherence isolated-client carrier from exact base `cf096f335a53c1ce056f570142ca9b20a13eb0b1`; the tracker remains open and TC2-10 remains blocked
