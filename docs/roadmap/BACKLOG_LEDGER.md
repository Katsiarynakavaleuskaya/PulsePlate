...
- [ ] P1: Reference-driven design intelligence wave for web and iOS
  ...
  - Target PR: PR #1671 (`docs(design): open reference-driven design intelligence wave for web and iOS`, branch `docs/design-intelligence-wave-v1`) -> PR-1 `feat(design): generate PulsePlate DESIGN.md from token and component contracts` (`feat/design-md-generator-v1`)
  - Status: PR-0 merged in PR #1671; PR-1 active on branch `feat/design-md-generator-v1` to add generated/drift-checked `docs/design/DESIGN.md`. Do not close the wave or mark PR-2/PR-3/PR-4/PR-5/PR-6 complete in this PR.
