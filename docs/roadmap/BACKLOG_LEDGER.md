...
- [ ] P1: TestClient lifecycle and session-fixture isolation cleanup
  ...
  - Status: 🟡 In progress — TC2-09E / PR #2353 is merged; TC2-09F / PR #2357 is the current bounded three-site nutrition-log isolated-client carrier from exact base `4d6d93faefd0264fc6a4650de8eac266b3c9558c`; the tracker remains open and TC2-10 remains blocked
