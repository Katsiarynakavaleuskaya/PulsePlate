...
- [ ] P1: FitChef support-outcome thin web transport
  ...
  - Dependency (EN): This item remains downstream of a separate exact authenticated/full-Web-parity
    measurement GO; the public deterministic marketing demo emits no outcome event and grants no
    transport authority.
