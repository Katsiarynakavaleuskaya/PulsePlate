...
- [ ] P1: Coordinator-first design runtime system web+iOS epic bootstrap and PR train
  ...
  - Target PR: PR #1497 (`docs(design): add coordinator-first design runtime system web-ios runbook`) -> PR TBD (`feat(frontend): add missing governed UI primitives v1`)
  - Status: 🛠️ PR-0 merged; PR-1 missing governed primitives lane in progress
