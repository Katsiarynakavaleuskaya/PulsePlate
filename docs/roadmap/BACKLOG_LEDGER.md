...
- [x] P1: Privileged workflow security-review requirement for orchestration and release surfaces
  ...
  - Reason: Tasks touching GitHub workflows/actions, Fastlane,
    ...
    frontend Caddy Dockerfile/npm manifests, iOS Gemfile manifests, GitHub
  ...
  - DoD:
    ...
    - Deterministic tests cover workflow/action/Fastlane/orchestration/release/docs/Trivy/root-Docker/devcontainer/deploy-Caddy-Compose/frontend-Caddy-Dockerfile/npm/iOS-Gemfile/GitHub-governance/dependency-manifest
      review routing
