...
- [ ] P1: Governed creative-code execution lane (PR-0 through PR-6)
  ...
  - Carryover: PR-TBD (`codex/creative-budget-promotion-fixture`; follow-up to PR `#2218`) restores changed-line parity only in `tests/test_creative_code_pr_promotion.py` and `tests/test_creative_code_artifact_inventory.py`; no production, schema, workflow, provider, OCW, R3, or product-behavior change.
