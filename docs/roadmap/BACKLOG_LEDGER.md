...
- [ ] P1: TestClient lifecycle and session-fixture isolation cleanup
  - Owner: @katsiaryna_kavaleuskaya
  - Priority: P1
  - Target PR: PR #2312 (TC2-09), merged PR #2325 / PR #2330 stabilization, merged PR #2332 direct-getter ownership stabilization, merged PR #2334 (TC2-09B), and current PR #2342 (TC2-09C); terminal TC2-10 remains TBD
  - Status: 🟡 In progress — TC2-09B / PR #2334 merged; TC2-09C / PR #2342 is the current carrier; tracker remains open and TC2-10 remains blocked
  ...
  - Progress:
    ...
    - Current TC2-09C carrier: PR #2342 code commit `4839fefcd2206ec37d0e26a1fdc8cbff81771b52` migrates only the three function-local `RawTestClient` construction sites in `tests/test_metrics.py`. Its reproduced code-head census is 378 sites / 93 files total and 377 / 92 outside `tests/_client.py`, with one canonical helper construction, zero target-file construction sites, and zero `RawTestClient` tokens. Merge and post-merge proof remain pending.
    - Residual boundary: exact post-PR-#2334 `origin/main@c6e1e17ab6e0406b3949d9bbf8e922e385638edc` contained 381 sites / 94 files total and 380 / 93 outside `tests/_client.py`; the current PR #2342 code head reduces that finite census to 378 / 93 total and 377 / 92 outside the helper. TC2-10 remains blocked until canonical callers reach zero and every terminal tracker condition passes.
