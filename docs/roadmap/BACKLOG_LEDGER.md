...
- [ ] P1: Coordinator-first design runtime system web+iOS epic bootstrap and PR train
  ...
  - Target PR: PR #1497 (`docs(design): add coordinator-first design runtime system web-ios runbook`) -> PR #1504 (`feat(frontend): add missing governed UI primitives v1`) -> PR #1510 (`feat(frontend): normalize specialized design families into shared governed patterns`) -> PR #1519 (`feat(tokens): add product-level token layer for planning and premium surfaces`, PR-3) -> PR #1527 (`feat(frontend): converge web shell onto governed tokens`, PR-4)
  - Status: 🛠️ PR-0 merged; PR-1 merged in PR #1504; PR-2 merged in PR #1510; PR-3 product token expansion merged in PR #1519; PR-4 web shell convergence is active in PR #1527 on branch `codex/frontend-product-shell-convergence`
...
- [x] P1: Tier 4 scientific / creative cell — PR0 governance packet + skill_router hooks (org tier only)
  ...
  - Status: ✅ Closed — merged PR #1548 (squash merge commit `6a001b340`). DoD met: PR0 packet + workforce cross-link + Tier 4 lane in `docs/orchestration/AGENTS.md`; `skill_router` Tier 4 path cues + `tests/test_skill_router.py`; evidence `docs/orchestration/TIER4_PR1548_AGENT_PASS_RECORD_2026-04-27.md`, `docs/review/PR_1548_FIXED_MAPPING.md`. No OpenAPI/runtime/autonomous-merge surface changes.
