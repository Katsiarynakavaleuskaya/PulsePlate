...
- `POST /api/v1/pro/fitchef/recommend`
  - landed deterministic descriptor-only support handoff via PR #2320 /
    `f95a329d899d5ac4fa73f198e90cfed44d0fc45c` on 2026-08-25
  ...
  - canonical details: [structured-coach contract](../contracts/FITCHEF_STRUCTURED_COACH_CONTRACT.md) and [landed ledger entry](../roadmap/BACKLOG_LEDGER.md#ledger-p1-fitchef-support-handoff)
- `POST /api/v1/vip/fitchef/insight`
