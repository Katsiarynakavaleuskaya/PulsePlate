...
Practical playbooks: how to run checks, diagnose failures, and perform safe operational tasks.
...
- [`TESTING_BEST_PRACTICES.md`](TESTING_BEST_PRACTICES.md) — patterns to write stable tests
- [`LOCALE_TESTS.md`](LOCALE_TESTS.md) — localization test notes
- [`RATE_LIMIT_TESTS.md`](RATE_LIMIT_TESTS.md) — rate limit / throttling related test notes
...
## Notes
Runbooks should be actionable. If a doc is mostly historical, move it to [`../reports/`](../reports/) or [`../archive/`](../archive/).
