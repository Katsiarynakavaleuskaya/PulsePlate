...
- FitChef structured coaching (`/api/v1/pro/fitchef/explain`, `/api/v1/vip/fitchef/insight`)
...
- coaching estructurado de FitChef (`/api/v1/pro/fitchef/explain`, `/api/v1/vip/fitchef/insight`)
