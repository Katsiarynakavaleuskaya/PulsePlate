...
- Required states: default / hover-pressed / focus / disabled / loading / error
- Figma page target: `00_Foundation_Tokens` / `01_Components` / `10_iOS_Home` / `11_iOS_Plate` / `12_iOS_Progress` / `20_Web_Parity`
...
- Stub ID: `ICON_STUB_V1` / `CTA_PRIMARY_STUB_V1` / `CTA_SECONDARY_STUB_V1` / `CTA_DISABLED_STUB_V1` / `CTA_LOADING_STUB_V1` / `CTA_ERROR_STUB_V1`
- Notes:
