...
| EXP-CBT-001: CBT coaching micro-surfaces | Adding bounded coaching scenarios (`distortion_simulator`, `identity_loop_mapper`) improves structured coaching completion and 7-day revisit/followthrough without breaching D7 retention, support, or LLM cost guardrails | 2026-03-24 | 2026-04-14 | Product + Data + Growth | Planned |
