...
- Plan and implement public launch-site pages, CTA funnels, waitlist/lead-capture paths, and wellness-safe launch copy: `pulseplate-web-launch-site`
- Shape agent-product surfaces, operator workflows, HITL boundaries, and product handoffs without creating runtime autonomy: `pulseplate-agent-product`
...
- `pulseplate-web-launch-site` for launch-site pages, CTA funnels, waitlist/lead-capture paths, and wellness-safe public launch copy
- `pulseplate-agent-product` for agent-product surfaces, operator workflows, HITL boundaries, and product handoffs that preserve coordinator authority
