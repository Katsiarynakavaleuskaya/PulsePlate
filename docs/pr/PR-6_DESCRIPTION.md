...
- [P1: Mobile secret storage conformance](../roadmap/BACKLOG_LEDGER.md#ledger-p1-mobile-secret-conformance) (iOS Keychain now, Android Keystore deferred)
...
Use the canonical sections above as the PR body source of truth.
Keep only the required merge-governance mirror in the GitHub PR body:
